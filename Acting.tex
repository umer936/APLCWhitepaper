...
\label{Acting Undergraduate Colleges}
\resizebox{\textwidth}{!}{%
\begin{tabular}{llrlr}
\hline
\multicolumn{5}{|l|}{Dream Schools}                                                                \\ \hline
University of California - Los Angeles & Total 4 year cost: & \$220,000 & 20 year ROI: & \$164,000 \\
Pace University                        & Total 4 year cost: & \$220,000 & 20 year ROI: & \$424,000 \\ \hline
\multicolumn{5}{|l|}{Best Value Schools}                                                           \\ \hline
University of California - Berkeley    & Total 4 year cost: & \$225,000 & 20 year ROI: & \$443,000 \\
UT Austin                              & Total 4 year cost: & \$103,000 & 20 year ROI: & \$301,000
\end{tabular}%
}
\end{table}
...
\section{Degree Description}
	\subsection{Undergraduate}
		...
		\begin{Figure}
			\centering
			\includegraphics[width=\linewidth]{images/Acting2}
			\captionof{figure}{A play stage (\textit{Empty Parisian Theatre})}
			\label{fig:Bohbot}
		\end{Figure}
...
\section{Interview}
	\begin{Figure}
	 \centering
	 \includegraphics[width=\linewidth]{images/Acting}
	 \captionof{figure}{A movie actor (\textit{Portrait of Callie Hernandez})}
	 \label{fig:Portrait of Callie Hernandez}
	\end{Figure}
